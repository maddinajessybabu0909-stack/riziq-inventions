...
function ProjectDetail() {
  ...
  return <main className="min-h-screen bg-background"><section className="page-intro pt-32 text-hero-foreground md:pt-40"><div className="mx-auto max-w-6xl px-6 pb-16 md:px-8 md:pb-20"><Link to="/projects" className="inline-flex items-center gap-2 text-sm font-semibold text-hero-muted"><ArrowLeft className="size-4"/> All case studies</Link><p className="mt-10 text-xs font-bold uppercase tracking-[0.24em] text-hero-muted">{project.industry}</p><h1 className="mt-4 max-w-4xl text-4xl font-bold leading-tight md:text-6xl">{project.title}</h1><p className="mt-6 max-w-2xl text-lg leading-7 text-hero-muted">{project.summary}</p></div></section>
